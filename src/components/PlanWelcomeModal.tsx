  ...
  [UserPlan.LIGHT]: [
    ...
    },
    {
      ...
      features: [
        ...
        { icon: 'robot-outline', text: 'AI分析レポート（10回/月）' },
      ],
      bg: '#0D2137',
      accent: '#5B9BD5',
    },
    {
      ...
      features: [
        ...
        { icon: 'file-pdf-box', text: 'PDF共有' },
        { icon: 'advertisements-off', text: '広告なしで記録に集中' },
        { icon: 'baseball', text: '20試合/月まで記録' },
      ],
      bg: '#1A2C40',
      accent: '#5B9BD5',
    },
  ...
  [UserPlan.STANDARD]: [
    ...
    },
    {
      ...
      features: [
        ...
        { icon: 'robot-outline', text: 'AI分析レポート（20回/月）' },
        { icon: 'baseball', text: '30試合/月まで記録' },
      ],
      bg: '#071525',
      accent: '#1A6BB5',
    },
    {
      ...
      features: [
        { icon: 'account-group-outline', text: 'チーム作成' },
        { icon: 'file-pdf-box', text: 'PDF共有' },
  ...
  [UserPlan.PRO]: [
    ...
    },
    {
      ...
      features: [
        ...
        { icon: 'eye-outline', text: '試合中 相手データ参照' },
      ],
      bg: '#1A1000',
      accent: '#D4AF37',
    },
