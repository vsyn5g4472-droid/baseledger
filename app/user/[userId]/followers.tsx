...
import { useFollowers, useFollow } from '../../../src/hooks/useFollow';
import { Colors, Spacing, Typography } from '../../../src/constants/theme';
import type { User } from '../../../src/models/types';

function FollowerItem({ user }: { user: User }) {
      ...
      <View style={styles.container}>
        {loading && followers.length === 0 ? (
          ...
          <FlatList
            ...
            contentContainerStyle={followers.length === 0 ? styles.emptyContainer : styles.listContent}
